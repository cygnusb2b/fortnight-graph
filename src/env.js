...
module.exports = cleanEnv(process.env, {
  ...
  BASE_URI: nonemptystr({ desc: 'The base URI where the server instance is running, e.g. fortnight.io.' }),
  ...
  DD_SERVICE_NAME: nonemptystr({ desc: 'The Datadog service name', default: 'nativex-graph', devDefault: '(unset)' }),
  DD_TRACE_AGENT_HOSTNAME: nonemptystr({ desc: 'The Datadog agent hostname', devDefault: '(unset)' }),
  DD_TRACE_AGENT_PORT: port({ desc: 'The Datadog agent port', default: 8126 }),
  DD_ENV: nonemptystr({ desc: 'The Datadog environment key', default: 'production', devDefault: 'development' }),
